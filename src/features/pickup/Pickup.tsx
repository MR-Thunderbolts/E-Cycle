      ...
      <div className="flex-1 overflow-y-auto p-6 pb-32">
        ...
        <div className="bg-white dark:bg-dark-surface rounded-[32px] p-6 shadow-sm mb-6 border border-gray-100 dark:border-dark-border transition-colors">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-12 h-12 bg-secondary/30 dark:bg-primary/20 rounded-full flex items-center justify-center text-primary-dark dark:text-accent">
        ...
        <div className="bg-secondary/20 dark:bg-primary/10 rounded-2xl p-4 flex gap-3 items-start mt-4">
          <span className="material-symbols-rounded text-primary-dark dark:text-accent">schedule</span>
          <div>
            <h4 className="text-sm font-bold text-primary-dark dark:text-accent">Horario de Atención</h4>
            <p className="text-xs text-primary-dark/80 dark:text-accent/80 mt-1">Lunes a Viernes de 9:00 a 18:00 hrs.</p>
          </div>
        </div>
      </div>
    </div>
